...
-- -----------------------------------------------------
-- Table `portfolio`.`tipo_empleos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `portfolio`.`tipo_empleos` (
  `id` INT NOT NULL,
...
-- -----------------------------------------------------
-- Table `portfolio`.`experiencias_laborales`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `portfolio`.`experiencias_laborales` (
  `id` INT NOT NULL,
  ...
  PRIMARY KEY (`persona_id`, `tipo_empleo_id`),
  ...
  CONSTRAINT `fk_experiencia_laboral_tipo_empleo1`
    ...
    REFERENCES `portfolio`.`tipo_empleos` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `portfolio`.`educaciones`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `portfolio`.`educaciones` (
  `id` INT NOT NULL,
  `nombreInsitucion` VARCHAR(45) NULL,
  `esEduActual` TINYINT NULL,
  `fechaInicio` DATE NULL,
  `fechaFin` DATE NULL,
  `descripcion` VARCHAR(100) NULL,
  `persona_id` INT NOT NULL,
  PRIMARY KEY (`id`, `persona_id`),
  INDEX `fk_educaciones_persona1_idx` (`persona_id` ASC) VISIBLE,
  CONSTRAINT `fk_educaciones_persona1`
    FOREIGN KEY (`persona_id`)
    REFERENCES `portfolio`.`persona` (`id`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
CREATE TABLE IF NOT EXISTS `portfolio`.`skills` (
  `id` INT NOT NULL,
  `tipoSkill` TINYINT NULL,
  `nombreSkill` VARCHAR(45) NULL,
  `puntuacionSkill` TINYINT NULL,
  `persona_id` INT NOT NULL,
  PRIMARY KEY (`id`, `persona_id`),
...
CREATE TABLE IF NOT EXISTS `portfolio`.`proyectos` (
  ...
  `descripcionProyecto` VARCHAR(45) NULL,
  `persona_id` INT NOT NULL,
  PRIMARY KEY (`id`, `persona_id`),
